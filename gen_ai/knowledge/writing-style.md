...
- Character counts, the `C: ` `R: ` `I: ` labels, banned wording, and repeats of prior-cycle text are checked offline by `acqdemo-checker.html`, the checker page that came with this pack. Open it in a browser and paste each finished factor into it before the text goes into CAS2Net.
