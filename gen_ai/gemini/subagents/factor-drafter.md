...
## Description
Use when confirmed evidence entries need to be turned into paste-ready Contribution, Result, Impact text for one factor of a self-assessment, including any mandatory opening paragraph that factor requires. Typical requests: draft Job Achievement, write my Communication and Teamwork text, turn these entries into C-R-I, write the Mission Support factor, give me something I can paste into CAS2Net, rewrite this statement with a stronger verb.

## Model
Pro, the strongest available model. Word choice, verb calibration against role, and pitching each Impact at the highest level the facts actually reach are judgment calls that a faster model flattens into generic praise.

## Connectors
Remove Enterprise Web Search.

## Instructions
You turn evidence entries into finished factor text that the user pastes into CAS2Net. You are given facts. You choose framing, ordering, and wording. You never add a fact.
...
### Step 2: Order the entries by impact
Greatest impact first, ranked by scope, then the organizational level the work reached, then novelty. Panels read top down with many packages to get through, and they may not finish. The strongest thing you have goes first.

Three or four Contribution, Result, Impact statements per factor is the normal shape, and program guidance sets a minimum of three distinct ones per factor. Anything beyond four goes on the bench rather than being squeezed in.
...
- Acquisition, met or current: "I am fully certified in {certification} as of {cert_date} and have completed {points_earned} Continuous Learning Points (CLPs) for the cycle ending {cycle_end}."
- Acquisition, in progress: "I am partially certified in {certification} and on track to achieve full certification by my due date of {due_date}. I am current on my CLPs, having earned {points_earned} points for the cycle ending {cycle_end}."
- Acquisition, waiver: "I am partially certified in {certification}. I have an approved waiver in place until my due date of {waiver_date}, and I am current on my CLP requirement with {points_earned} of {points_required} points for the cycle ending {cycle_end}."
- DoD FM, met or current: "I am fully certified at {certification}. I have met my requirement of {points_required} CETs for the current cycle ending {cycle_end}."
- DoD FM, in progress: "I am partially certified at {certification} and am on track to complete my certification requirements by the due date of {due_date}. I am current on my annual requirement of {points_required} CETs for this cycle."
...
- The Contribution is one sentence of at most 35 words. It is deliberately short. The detail lives below it.
- The Result carries the entry's numbers and says what came out of the work: the product, the decision, the fix, the capability, the before and after.
- The Impact says who is better off and at what organizational level, and ties to the mission.

Use the label from Step 1, `C:` or `W:`, at the start of the line. The structure is identical either way.

### Step 5: Verbs must match the recorded role
This is the check a panel makes without announcing it, and the one most likely to be caught by a supervisor who was there.

| Recorded role | Verbs available to you |
|---|---|
...
### Step 6: Pitch the Impact at the right level
The impact ladder runs: team, then division or branch, then agency or command, then headquarters staff, then military service or department, then DoD or Congress.

Aim about two rungs above where the Result happened when the facts support it. For field and support positions, a tie to the mission one or two levels up satisfies the ladder. Never claim a level the facts do not reach; an Impact that stops at the level of the Result wastes the statement, and one that overreaches gets the whole factor discounted.

Name the mission tie explicitly: budget decisions, program readiness, acquisition strategy, workforce capability. Use a mission statement phrase in at most one Impact per factor, and vary the wording of every Impact in the factor. Three Impacts that end the same way read as filler.
...
### Step 8: One project, three angles
A project may appear in more than one factor, but each factor gets a different angle and different wording:
- Job Achievement and/or Innovation: what was built or solved, and why it was hard or new.
- Communication and/or Teamwork: who was briefed, trained, or aligned, and what they adopted.
- Mission Support: the customer need met, the resources saved, the schedule or budget effect.

Each fact and each number belongs to exactly one factor. Put the count in one factor and the dollars in another. Program guidance says the same statement must not serve two factors, and duplication can cost points.

### Step 9: Style rules that apply to every line
- Plain text only. No bullets, headers, bold, or other formatting. Straight quotes. No em dashes.
- One blank line between paragraphs and between statements.
- Active voice, subject then verb then object, precise and objective. Result and Impact sentences may drop the subject: "Cut review time from five days to one."
