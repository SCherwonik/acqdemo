...
- `skills/acqdemo-harvest/scripts/git_harvest.py`: commits, months, authors, and tags from local repositories (`git log`) and GitHub repositories (`gh api`), merge commits skipped.
- `skills/acqdemo-harvest/scripts/calendar_harvest.py`: a calendar list export (Subject and Start, tab-separated; README Section 6.4) filtered to the rating period, with canceled meetings skipped, recurring series counted, and meetings listed by month.

Tests live in `skills/acqdemo-harvest/scripts/tests/`.
...
**Files:**
- Create: `skills/acqdemo-harvest/scripts/git_harvest.py`
- Create: `skills/acqdemo-harvest/scripts/tests/test_git_harvest.py`
...
Run: `python -m pytest skills/acqdemo-harvest/scripts/tests/test_git_harvest.py`
...
```bash
git add skills/acqdemo-harvest/scripts
...
**Files:**
- Modify: `skills/acqdemo-harvest/scripts/git_harvest.py` (append)
- Modify: `skills/acqdemo-harvest/scripts/tests/test_git_harvest.py` (append)

- [ ] **Step 1: Append the failing tests**

Append to `skills/acqdemo-harvest/scripts/tests/test_git_harvest.py`:
...
Append to `skills/acqdemo-harvest/scripts/git_harvest.py`:
...
Run: `python skills/acqdemo-harvest/scripts/git_harvest.py --since 2025-10-01 --until 2026-09-30 --local .`
...
**Files:**
- Create: `skills/acqdemo-harvest/scripts/calendar_harvest.py`
- Create: `skills/acqdemo-harvest/scripts/tests/test_calendar_harvest.py`

- [ ] **Step 1: Write the failing tests**

Create `skills/acqdemo-harvest/scripts/tests/test_calendar_harvest.py`. The export below uses real tab characters between columns (`\t`):
...
Run: `python -m pytest skills/acqdemo-harvest/scripts/tests/test_calendar_harvest.py`
...
**Files:**
- Modify: `skills/acqdemo-harvest/scripts/calendar_harvest.py` (append)
- Modify: `skills/acqdemo-harvest/scripts/tests/test_calendar_harvest.py` (append)

- [ ] **Step 1: Append the failing tests**

Append to `skills/acqdemo-harvest/scripts/tests/test_calendar_harvest.py`:
...
Append to `skills/acqdemo-harvest/scripts/calendar_harvest.py`:
